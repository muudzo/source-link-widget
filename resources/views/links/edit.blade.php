...
<head>
    ...
    <title>Edit Link - Source Link Widget</title>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update your saved link</p>
                    </div>
                ...
                <form action="{{ route('links.update', $link) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Add a description to help you remember why you saved this link">{{ old('description', $link->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="url" 
                               id="favicon" 
                               name="favicon" 
                               value="{{ old('favicon', $link->favicon) }}"
                            ...
                            @foreach($categories as $category)
                                <label class="flex items-center space-x-2 cursor-pointer">
                                    <input type="checkbox" 
                                           name="categories[]" 
                                           value="{{ $category->id }}"
                                           {{ in_array($category->id, old('categories', $link->categories->pluck('id')->toArray())) ? 'checked' : '' }}
